;;; monochrome-theme.el --- Theme using Template SCSS variables -*- lexical-binding: t -*-
...
(deftheme monochrome "Theme using Template variables with quality of life improvements.")

;; Define all the color variables (replaced by template processor)
(let* ((bg "#0a0a0a")
       (err "#d94a59")
       (err-container "#650b15")
       ...
       (outline-variant "#373737")
       (primary "#e2e2e2")
       (primary-container "#9a7777")
       (secondary "#8a8a8a")
       (secondary-container "#2c2121")
       (shadow "#000000")
       (surface "#0a0a0a")
       (surface-container "#8a8a8a")
       (surface-container-high "#232323")
       (surface-container-highest "#2d2d2d")
       (surface-container-low "#111111")
       (surface-container-lowest "#0d0d0d")
       (surface-variant "#8a8a8a")
       (tertiary "#8a8a8a")
       (tertiary-container "#2c2121")
       ;; Map success colors to tertiary (as used in other templates)
       (success "#8a8a8a")
       (on-success "#e2e2e2")
       (success-container "#2c2121")
       (on-success-container "#e6e6e6")
       ;; Map fixed colors to regular colors
       (primary-fixed "#e2e2e2")
       (primary-fixed-dim "#9a7777")
       (secondary-fixed "#8a8a8a")
       (secondary-fixed-dim "#2c2121")
